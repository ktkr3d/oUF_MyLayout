...
ns.SetupOptions = function()
    local options = {
        ...
        args = {
            ...
            focus = CreateUnitGroup("Focus", "Focus Frame", 22, true, true),
            pet = CreateUnitGroup("Pet", "Pet Frame", 23, true, true),
            party = CreateUnitGroup("Party", "Party Frame", 24, true, true),
            raid = CreateUnitGroup("Raid", "Raid Frame", 25, false, true, 4, 5),
            boss = CreateUnitGroup("Boss", "Boss Frame", 26, false, true, 4, 5),
            maintank = CreateUnitGroup("MainTank", "MainTank Frame", 27, false, true),
